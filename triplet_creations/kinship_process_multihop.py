...
def generate_questions(paths: List[List[str]]) -> List[str]:
    ...
    for triplets in paths:
        ...
        query_entities.append(triplet[0]) # Accessing the head from the first triplet
    ...
    return questions, questions_alt, answers, query_entities, query_relations, answer_entities, sequential_query_relations, hops
...
if __name__ == "__main__":
    ...
    questions, question_alt, answers, query_entities, query_relations, answer_entities, sequential_query_relations, hops = generate_questions(paths)
    ...
    output_df = pd.DataFrame({
        ...
        'Query-Entity': query_entities,                 # Source entity (starting point of the path)
